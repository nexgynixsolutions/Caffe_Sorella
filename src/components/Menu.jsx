...
const MENU_ITEMS = [
  ...
  { id: 14, category: 'Breakfast', name: 'Smashed Avo with Poached Eggs', price: 'Bestseller', desc: 'Smashed avocado topped with perfectly poached eggs.', image: 'https://images.unsplash.com/photo-1482049016688-2d3e1b311543?w=600&q=80&auto=format', tag: 'Bestseller' },
